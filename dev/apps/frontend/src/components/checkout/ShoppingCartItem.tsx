...
export default function ShoppingCartItem(props: ShoppingCartItemProps) {
  ...
  return (
    <div className="flex items-center px-8 py-0 rounded-xl gap-16">
      <img src={product.image} width={100} height={0} alt="image product" />
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="flex items-center border border-zinc-300 rounded-lg">
          ...
          <span className="border-x  text-lg px-4 py-0.5">{quantity}</span>
          <button className="px-2 py-0.5 text-blue-500" onClick={props.addItem}>
            <IconPlus size={15} />
          </button>
        </div>
        <button
